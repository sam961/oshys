 ...
 * Access at: https://yoursite.com/deployment-status.php?key=YOUR_STATUS_PASSWORD
 *
...
$password = $env['DEPLOY_STATUS_PASSWORD'] ?? '';
$repoDir = $env['DEPLOY_REPO_DIR'] ?? '/home2/bbgxbgmy/projects/oshys';
$logFile = __DIR__ . '/deployment.log';

// Password protection
if (empty($password) || !isset($_GET['key']) || $_GET['key'] !== $password) {
    http_response_code(403);
    die('Access denied. Add ?key=YOUR_STATUS_PASSWORD to URL');
}
