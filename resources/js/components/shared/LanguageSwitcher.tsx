    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown */}
          <div className="absolute top-full mt-2 right-0 z-50 min-w-[200px] bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
