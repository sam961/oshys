...
export const services = [
  {
    ...
    description: 'Begin your underwater adventure with our foundational Open Water program, guided safely and confidently by certified professionals.',
    icon: 'GraduationCap',
  ...
  {
    id: 2,
    title: 'Develop Your Diving',
    description: 'Blue Watch and advanced training programs to build your skills, confidence, and experience underwater.',
    icon: 'Award',
  ...
  {
    id: 3,
    title: 'Explore the Sea',
    description: 'Organized diving expeditions to selected dive sites, led by certified professionals.',
    icon: 'Compass',
