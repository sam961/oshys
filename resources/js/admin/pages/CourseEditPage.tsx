...
import { useGetCourseQuery, useCreateCourseMutation, useUpdateCourseMutation, useUploadCourseImagesMutation, useDeleteCourseImageMutation, useSetCourseMainImageMutation, useReorderCourseImagesMutation, useAddOccurrenceMutation } from '../../services/api';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        await saveDraftDates('courses', newCourse.id);
