        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <FormSection title="Featured Image" description="Upload or choose from the media library">
              <ImageUploadWithCrop onImageCropped={(f, u) => { setImageFile(f); setImagePreview(u); setSelectedImagePath(''); }} currentPreview={imagePreview} guideline={IMAGE_GUIDELINES.blog} />
